...
class NSDAccess(object):
    ...
    def load_coco_annotations(self,
        ...
        Parameters
        ----------
        info_types : list, optional
            [description], by default ['captions', 'person_keypoints', 'instances']
        coco_splits : list, optional
            [description], by default ['train2017', 'val2017']
        """
        self.coco_annotations = {}
        for info_type in info_types:
            for coco_split in coco_splits:
                annot_file = self.coco_annotation_file.format(
                    info_type, coco_split)
